...
$(function() {
  ...
  var config = {
    apiKey: "AIzaSyAIZ8jkv7GG8QmRdT84uJ5x6pIGqtnpTZQ",
    authDomain: "rt-stickies.firebaseapp.com",
    databaseURL: "https://rt-stickies.firebaseio.com",
    storageBucket: "rt-stickies.appspot.com",
  ...
  //Setting up an observer on a signed-in user (Auth Object) aka authData
    ...
    //var authDataCallback = function(authData) {
      var authDataCallback = firebase.auth().onAuthStateChanged(function(user) {
    ...
    var loadProfile = function() {
        ...
        userRef.once('value', function(snap) {
            ...
            addUserWelcome(userData.displayName);
            goToTab("#lists");
        });
    }
